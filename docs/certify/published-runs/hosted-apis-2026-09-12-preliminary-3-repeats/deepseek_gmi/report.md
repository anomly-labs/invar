# Determinism certification — `https://openrouter.ai/api/v1` model `deepseek/deepseek-chat-v3-0324` (2026-09-12T17:17:09Z)
...
|---|---|---|
| L0 | run-to-run deterministic | **fail** — 3 distinct workload output(s) in 3 repeats; 3/3 pairs differ; max logprob delta 5.137e-01; token divergence no |
...
errors: 0; observations digest `f9a8f52547734926…`; certificate `sha256:65953348954ccb94892e085e1d01484a24e693521355fba800a2770f6c4bc1bd`
