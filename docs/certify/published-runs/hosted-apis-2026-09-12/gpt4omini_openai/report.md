# Determinism certification — `https://openrouter.ai/api/v1` model `openai/gpt-4o-mini` (2026-09-12T17:47:23Z)
...
|---|---|---|
| L0 | run-to-run deterministic | **fail** — 10 distinct workload output(s) in 10 repeats; 45/45 pairs differ; max logprob delta 9.233e-02; token divergence no |
...
errors: 0; observations digest `85c94b8c72986619…`; certificate `sha256:4b1228679bd1231a2928e136dfb24d1afef3522b0f187cde361a5fc85702bca0`
